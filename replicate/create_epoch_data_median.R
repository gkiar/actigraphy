...
for (i in c(1:length(meta_files))) {
  ...
  subjectData <- reformat_data(subjectData, ID[[i]], method = 'median')
...
allData10 <- downsample(allData, 10, method = 'median')

#export downsampled dataset
write_csv(allData10, '/data2/HBNcore/CMI_HBN_Data/actigraphy/processed_data/epoch/aggregate/HBN_actigraphy_600s_median.csv')
...
filteredData10 <- downsample(filteredData, 10, method = 'median')
...
write_csv(filteredData, '/data2/HBNcore/CMI_HBN_Data/actigraphy/processed_data/epoch/aggregate/HBN_actigraphy_60s_95wear_3day_median.csv')

#export cleaned 600s epoch dataset
write_csv(filteredData10, '/data2/HBNcore/CMI_HBN_Data/actigraphy/processed_data/epoch/aggregate/HBN_actigraphy_600s_95wear_3day_median.csv')